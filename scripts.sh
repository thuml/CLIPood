# Domain shift
python main.py DomainBed/domainbed/data/ -d PACS           --task domain_shift -b 12 --lr 5e-6 --epochs 10 --lambda 0.3 --beta 0.5
python main.py DomainBed/domainbed/data/ -d VLCS           --task domain_shift -b 12 --lr 5e-6 --epochs 10 --lambda 0.3 --beta 0.5
python main.py DomainBed/domainbed/data/ -d OfficeHome     --task domain_shift -b 12 --lr 1e-5 --epochs 10 --lambda 0.3 --beta 0.5
python main.py DomainBed/domainbed/data/ -d TerraIncognita --task domain_shift -b 12 --lr 5e-6 --epochs 10 --lambda 0.3 --beta 0.5
python main.py DomainBed/domainbed/data/ -d DomainNet      --task domain_shift -b 12 --lr 1e-5 --epochs 20 --lambda 0.3 --beta 0.5
...
# In-the-wild
python main.py DomainBed/domainbed/data/ -d OfficeHome --task in_the_wild -b 12 --lr 3e-6 --epochs 10 --lambda 0.1 --beta 0.1
python main.py DomainBed/domainbed/data/ -d DomainNet  --task in_the_wild -b 12 --lr 5e-6 --epochs 20 --lambda 0.1 --beta 0.5
